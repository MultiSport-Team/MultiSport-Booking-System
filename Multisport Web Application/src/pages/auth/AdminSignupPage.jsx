...
const AdminSignupPage = () => {
  ...
  // Admin code constant - matching mobile app
  const ADMIN_CODE = 'MULTISPORT2026';
  ...
  const validateForm = () => {
    ...
    // Admin code validation - CRITICAL
  ...
  return (
    <div className="auth-container">
      <div className="auth-card admin-signup-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          {/* Admin Code - IMPORTANT FIELD */}
          <div className="mb-3">
            <label htmlFor="adminCode" className="form-label admin-code-label">
              🔑 Admin Code <span className="required">*</span>
            </label>
            <div className={`input-wrapper ${errors.adminCode ? 'input-error' : ''}`}>
              <input
        ...
        <div className="auth-footer">
          <p>
            Not an admin? <Link to="/signup" className="auth-link">User/Vendor Signup</Link>
          </p>
          <p className="mt-2">
            Already have an admin account? <Link to="/admin/login" className="auth-link">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
